package com.TLBTECh.proj_bff_agendador_tarefas.controller;


import com.TLBTECh.proj_bff_agendador_tarefas.business.UsuarioService;
...
public class UsuarioController {
    ...
    @PutMapping("/endereco")
    @Operation(summary = "Atualiza Endereco de  Usuários", description = "Atualiza endereço de usuário")
    ...
    @Operation(summary = "Salva Endereco de  Usuários", description = "Salva endereço de usuário")
